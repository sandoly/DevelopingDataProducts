...
```{r, opts.label = 'shiny', cache=T}
  require(shiny)
  require(rCharts)
  slidifyUI(
  	sidebarPanel(	numericInput("age", h4("Age:"), 20, min = 0, max = 110),
    ...
    mainPanel(width = 600, tags$div(id = 'chartCal', class='shiny-html-output Highcharts rChart')
            )
    )
```
